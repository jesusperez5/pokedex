...
public class PokedexFragment extends Fragment implements PokemonAdapter.OnItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerView recyclerView = view.findViewById(R.id.pokedexrvf);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        //Establecemos el adaptador en el recyclerView
        recyclerView.setAdapter(pokemonAdapter);

        EditText filterInput = view.findViewById(R.id.filterInput);

        Switch fuego = view.findViewById(R.id.fireButton);
        Switch planta = view.findViewById(R.id.grassButton);
        Switch agua = view.findViewById(R.id.waterButton);

        ImageButton limpiar = view.findViewById(R.id.clearButton);
        ...
        limpiar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(getContext(), getString(R.string.clearLog), Toast.LENGTH_SHORT).show();

                Log.i(getContext().getString(R.string.comprobacion), getString(R.string.texto_del_filtro_eliminado) + filterInput.getText());
            }
        });

        Button filtrar = view.findViewById(R.id.filterButton);
        ...
        filtrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(tipos.size() > 0 && tipos.size() < 3 || !nombreFiltro.equals("")){ // si esta 1 o dos marcados o bien hay un nombre para filtrar...
                    ...
                    PokemonAdapter pokemonFilteredAdapter = new PokemonAdapter(pokemonsFiltered, PokedexFragment.this); // creamos el nuevo adapter con los pokemons filtrados
                    recyclerView.setAdapter(pokemonFilteredAdapter);
                    Toast.makeText(getContext(), R.string.filtro_realizado, Toast.LENGTH_SHORT).show();
                } else {
                    recyclerView.setAdapter(pokemonAdapter);
                }
            }
    ...
    public void onItemClick(Pokemon pokemon) { // Evento para cuando clickas en un pokemon
        ...
        Toast.makeText(getContext(), pokemon.getDescripcion(), Toast.LENGTH_SHORT).show();
    }
